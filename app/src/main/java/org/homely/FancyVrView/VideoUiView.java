...
import org.homely.FancyVrView.rendering.CanvasQuad;
import org.homely.R;
...
public class VideoUiView extends LinearLayout {
  ...
  public static VideoUiView createForOpenGl(Context context, ViewGroup parent, CanvasQuad quad) {
    ...
    view.findViewById(R.id.enter_exit_vr).setContentDescription("exit vr");
        ...
        new OnClickListener() {
          ...
          public void onClick(View v) {
            ...
            if (mediaPlayer.isPlaying()) {
              mediaPlayer.pause();
              playPauseToggle.setBackgroundResource(R.drawable.quantum_ic_info_white_24);
              playPauseToggle.setContentDescription("play");
            } else {
              mediaPlayer.start();
              playPauseToggle.setBackgroundResource(R.drawable.quantum_ic_info_white_24);
              playPauseToggle.setContentDescription("pause");
            }
          }
        });
